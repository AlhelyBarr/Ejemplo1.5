<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Root.master" CodeBehind="SignIn.aspx.cs" Inherits="Ejemplo1.SignInModule" Title="Sign In" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <div class="formLayout-verticalAlign">
        <div class="formLayout-container">
            <div align="center">
                <img src="../Content/Photo/gonherLogo.jpg" Width="80%"/> 
            </div>
            <br>

            <dx:ASPxTabControl ID="SignInRegisterTabControl" runat="server" Width="100%" TabAlign="Justify" Paddings-Padding="0" ActiveTabIndex="1">
                <Tabs>
                    ...
                    <dx:LayoutGroup GroupBoxDecoration="HeadingLine" ShowCaption="False">
                        ...
                        <Items>
                            <dx:LayoutItem ShowCaption="False" HorizontalAlign="Center" Paddings-Padding="0">
                                <LayoutItemNestedControlCollection>
                                    <dx:LayoutItemNestedControlContainer>
                                        <dx:ASPxButton ID="SignInButton" BackColor="red" runat="server" Width="200" Text="Log In" OnClick="SignInButton_Click"></dx:ASPxButton>
                                    </dx:LayoutItemNestedControlContainer>
                                </LayoutItemNestedControlCollection>
                            </dx:LayoutItem>
                        </Items>
